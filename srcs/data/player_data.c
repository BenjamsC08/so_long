...
/*   Updated: 2025/01/08 16:40:14 by benjamsc         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	data->perso.down_ptr[0] = mlx_xpm_file_to_image(data->mlx,
	...
	data->perso.down_ptr[1] = mlx_xpm_file_to_image(data->mlx,
			PLAYER_DOWN_2, &data->tiles.size, &data->tiles.size);
	data->perso.down_data[1] = (int *)mlx_get_data_addr(data->perso.down_ptr[1],
			&data->map.bpp, &data->map.line_len, &data->map.endian);
	data->perso.up_ptr[0] = mlx_xpm_file_to_image(data->mlx,
			PLAYER_UP_1, &data->tiles.size, &data->tiles.size);
	data->perso.up_data[0] = (int *)mlx_get_data_addr(data->perso.up_ptr[0],
			&data->map.bpp, &data->map.line_len, &data->map.endian);
	data->perso.up_ptr[1] = mlx_xpm_file_to_image(data->mlx,
			PLAYER_UP_2, &data->tiles.size, &data->tiles.size);
...
static void	player_img_x(t_data *data)
{
	...
	data->perso.left_data[0] = (int *)mlx_get_data_addr(data->perso.left_ptr[0],
			&data->map.bpp, &data->map.line_len, &data->map.endian);
	data->perso.left_ptr[1] = mlx_xpm_file_to_image(data->mlx,
			PLAYER_LEFT_2, &data->tiles.size, &data->tiles.size);
