...
/*   Updated: 2025/02/11 21:25:27 by benjamsc         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	base_map_img(t_data *data)
{
	...
	data->tiles.wall_ptr = mlx_xpm_file_to_image(data->mlx, WALL_IMG,
			&data->tiles.size, &data->tiles.size);
	data->tiles.wall_data = (int *)mlx_get_data_addr(data->tiles.wall_ptr,
			&data->map.bpp, &data->map.line_len, &data->map.endian);
	data->tiles.coll_ptr = mlx_xpm_file_to_image(data->mlx, COLLECTIBLE_IMG,
			&data->tiles.size, &data->tiles.size);
	data->tiles.coll_data = (int *)mlx_get_data_addr(data->tiles.coll_ptr,
			&data->map.bpp, &data->map.line_len, &data->map.endian);
	data->tiles.door_ptr[0] = mlx_xpm_file_to_image(data->mlx, DOOR_CLOSE_IMG,
			&data->tiles.size, &data->tiles.size);
	data->tiles.door_data[0] = (int *)mlx_get_data_addr(data->tiles.door_ptr[0],
			&data->map.bpp, &data->map.line_len, &data->map.endian);
	data->tiles.door_ptr[1] = mlx_xpm_file_to_image(data->mlx, DOOR_OPEN_IMG,
			&data->tiles.size, &data->tiles.size);
...
static int	ground_img(t_data *data)
{
	if (!alloc_map_img_ptr_data(data))
		return (0);
	data->tiles.ground_ptr[0] = mlx_xpm_file_to_image(data->mlx, GROUND_IMG_1,
			&data->tiles.size, &data->tiles.size);
	data->tiles.ground_data[0] = (int *)mlx_get_data_addr(
			data->tiles.ground_ptr[0],
			&data->map.bpp, &data->map.line_len, &data->map.endian);
	data->tiles.ground_ptr[1] = mlx_xpm_file_to_image(data->mlx, GROUND_IMG_2,
			&data->tiles.size, &data->tiles.size);
	data->tiles.ground_data[1] = (int *)mlx_get_data_addr(
			data->tiles.ground_ptr[1], &data->map.bpp, &data->map.line_len,
			&data->map.endian);
	data->tiles.ground_ptr[2] = mlx_xpm_file_to_image(data->mlx, GROUND_IMG_3,
			&data->tiles.size, &data->tiles.size);
	data->tiles.ground_data[2] = (int *)mlx_get_data_addr(
			data->tiles.ground_ptr[2], &data->map.bpp, &data->map.line_len,
			&data->map.endian);
	data->tiles.ground_ptr[3] = mlx_xpm_file_to_image(data->mlx, GROUND_IMG_4,
			&data->tiles.size, &data->tiles.size);
