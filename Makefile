...
NAME = so_long
SRCS = check_map.c check_map_utils.c colors_utils.c errors.c frees.c get_data.c get_map.c main.c map_management.c draw.c win_management.c moove.c enemy.c
OBJ = $(SRCS:.c=.o)
